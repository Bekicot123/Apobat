...
class DetailVitamin extends StatefulWidget {
  ...
  final String id;
  const DetailVitamin({Key? key, required this.id}) : super(key: key);

  @override
  State<DetailVitamin> createState() => _DetailVitaminState();
}

class _DetailVitaminState extends State<DetailVitamin> {
